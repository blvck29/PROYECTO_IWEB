...
<html lang="en">
<head>
  <title>Administración de Apoyos</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
           ...
           <form method="post" action="<%=request.getContextPath()%>/EventoServlet?action=busqueda">
            ...
            <button type="submit" class="btn btn-primary">Aplicar filtros</button>
             ...
             <a class="btn btn-primary" href="<%=request.getContextPath()%>/EventoServlet" role="button">Borrar filtros</a>
           </form>
