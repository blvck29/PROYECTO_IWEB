...
<div class="table-responsive container">
    <table id="inscritos" class="table table-striped table-bordered" style="width:100%">
        ...
        <tr class="">
            ...
            <td class="cell c5" style=""><a href="<%=request.getContextPath()%>/admin_act?action=editarRolInscrito&idInscrito=<%=inscrito.getUsuario().getIdUsuario()%>&idevento=<%=idEvento%>"><img width="24" height="24" src="https://img.icons8.com/sf-regular/48/edit-row.png" alt="edit-row"/></a></td>
